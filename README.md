...
By combining denoising and attention mechanisms, the framework improves detection performance in challenging subsurface environments where GPR B-scan images suffer from noise, clutter, and overlappting reflections.
